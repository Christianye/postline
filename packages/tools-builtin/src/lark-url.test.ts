...
describe('parseLarkUrl', () => {
  const samples: Array<[string, { kind: string; token: string } | null]> = [
    ...
    ['https://bytedance.feishu.cn/docx/doxcnby5Y0yoACL3PdfZqrJEm6f', { kind: 'docx', token: 'doxcnby5Y0yoACL3PdfZqrJEm6f' }],
    ...
    ['https://bytedance.feishu.cn/wiki/Xl2IfJrl2l9AsKdh6PJcseaVndb', { kind: 'wiki', token: 'Xl2IfJrl2l9AsKdh6PJcseaVndb' }],
    ['not a url', null],
